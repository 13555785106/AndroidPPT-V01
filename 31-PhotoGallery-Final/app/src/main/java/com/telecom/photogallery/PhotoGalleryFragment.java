...
public class PhotoGalleryFragment extends NotificationFragment {
    private static final String TAG = "PhotoGalleryFragment";
    private static final String baseListImageUrl = "http://192.168.3.50:8080/PhotoGallery/sample/ListImage";
    private static final String baseViewImageUrl = "http://192.168.3.50:8080/PhotoGallery/sample/img.jsp";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        new FetchItemsTask(mPhotoAdapter).execute(new String[]{baseListImageUrl, QueryPreferences.getStoredQuery(getActivity()), "UTF-8"});
    }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String s) {
                ...
                new FetchItemsTask(mPhotoAdapter).execute(new String[]{baseListImageUrl, s, "UTF-8"});
                return true;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_item_clear:
                ...
                new FetchItemsTask(mPhotoAdapter).execute(new String[]{baseListImageUrl, null, "UTF-8"});
                return true;
    ...
    private class PhotoHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        @Override
        public void onClick(View v) {
            //Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(baseViewImageUrl+"?id="+mPhotoItem.getId()));
            Intent intent = PhotoPageActivity.newIntent(getActivity(), Uri.parse(baseViewImageUrl+"?id="+mPhotoItem.getId()));
