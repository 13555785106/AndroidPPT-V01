...
public class MotionEventActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTouchMeImageView = (ImageView) findViewById(R.id.touch_me_image_view);
        mTouchMeImageView.setOnTouchListener(new View.OnTouchListener() {
