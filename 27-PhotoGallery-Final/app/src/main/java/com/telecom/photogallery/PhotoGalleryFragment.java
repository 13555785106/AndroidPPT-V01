...
public class PhotoGalleryFragment extends Fragment {
    ...
    private LinearLayout mImageLoadingLinearLayout;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImageLoadingLinearLayout = v.findViewById(R.id.image_loading_linear_layout);
    ...
    private class FetchItemsTask extends AsyncTask<String, Void, PhotoResult> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mImageLoadingLinearLayout.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(PhotoResult photoResult) {
            ...
            mImageLoadingLinearLayout.setVisibility(View.GONE);
