...
public class GaoDeMapFragment extends Fragment {
    ...
    private LatLng syzPos = new LatLng(41.793762, 123.396797);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        aMap = mapView.getMap();
        //设置中心点及缩放倍数
        aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(syzPos, 15));
        //点击地图添加Marker
        ...
        //绘制圆
        Circle circle = aMap.addCircle(new CircleOptions().center(new LatLng(41.807838, 123.396476))
                .radius(180).strokeColor(Color.MAGENTA)
                .fillColor(Color.argb(150, 255, 153, 51))
                .strokeWidth(15));
        //绘制线
        List<LatLng> latLngs = new ArrayList<LatLng>();
        latLngs.add(new LatLng(41.793762, 123.396797));
        latLngs.add(new LatLng(41.807838, 123.396476));
        latLngs.add(new LatLng(41.804958, 123.408752));
        latLngs.add(new LatLng(41.793762, 123.396797));

        Polyline polyline = aMap.addPolyline(new PolylineOptions()
                .setDottedLine(true)
                .addAll(latLngs).width(16).color(Color.argb(255, 200, 100, 100)));
        initLocation();
