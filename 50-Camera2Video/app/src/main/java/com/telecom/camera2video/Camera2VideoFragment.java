...
package com.telecom.camera2video;
...
public class Camera2VideoFragment extends Fragment
    ...
    /**
     * 本例中，我们为视频3/4的纵横比，同时宽度不大于1080p,因为MediaRecorder不支持更高分辨率的视频
     */
    ...
    private void updatePreview() {
        ...
        try {
            ...
            HandlerThread thread = new HandlerThread("CameraPreview");//这是干啥的？
            thread.start();//----------------------------------------------------
